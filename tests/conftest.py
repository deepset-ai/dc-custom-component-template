...
from dc_custom_component.utils.nvidia import Model, NimBackend
...
class MockBackend(NimBackend):
    def __init__(
        ...
        super().__init__(
            model, api_url="", api_key=api_key, model_kwargs=model_kwargs or {}
        )
    ...
    def generate(self) -> Tuple[List[str], List[Dict[str, Any]]]:  # type: ignore
        return (
